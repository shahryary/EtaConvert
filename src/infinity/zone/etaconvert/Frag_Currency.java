...
import infinity.zone.convertors.Currency;
...
public class Frag_Currency extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		main_arr = getResources().getStringArray(R.array.Currency_list);
		...
		Toast.makeText(getActivity().getApplicationContext(),"we get all information on http://finance.yahoo.com/ ",
		...
		filterText.addTextChangedListener(new TextWatcher() {
			...
			public void afterTextChanged(Editable arg0) {
				Frag_Currency.this.arrAdapt.getFilter().filter(arg0);
	...
	public void myCalculate(String userValue, String Des) {
		...
		try {
			if (Des.equalsIgnoreCase("from")) {
				tempText = (newCal.cur(droppedItemFrom, droppedItemTo,
						enteredValue));
				...
				tempText = (newCal.cur(droppedItemTo, droppedItemFrom,
						enteredValue));
	...
	public void Anim() {
		...
		pd.setMessage("Please wait to synchronous data ....");
		pd.show();
	}
}
